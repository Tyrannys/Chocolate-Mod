...
public class FluidGeneration {
    public static void generateFluids(final BiomeLoadingEvent event) {
        if(!(event.getCategory().equals(Biome.Category.NETHER) || event.getCategory().equals(Biome.Category.THEEND))) {
            GenerateFluid(event.getGeneration(), OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, ModBlocks.MELTED_CHOCOLATE.get()
    ...
    private static void GenerateFluid(BiomeGenerationSettingsBuilder settings, RuleTest fillerType, BlockState state,
